...
Work experience
======
### Product Analyst/Owner (ToB)  
**China Mobile (Migu Video Technology)** | Shanghai, China | May 2021 – July 2024 (3 years)  
- Developed interactive dashboards of “Video Engagement”, “Revenue & Settlement” module, providing internal teams and B2B partners with transparent, data-rich financial insights  
...
- Built CRM tools for in-game transaction tracking and chatbot FAQs, create documentation for user help center, increasing self-service resolution rate by 47%.
...
- Led the end-to-end setup of a DDEX + FTP transfer system, facilitating the acquisition and integration 
of Japanese music content into the company’s digital catalog  

### Music Copyright Operation (intern)  
**Kanjian Music(en.kanjian.com)** | Shanghai, China | January 2015 – March 2018 (2 year)  
- Optimized music rights distribution platform and automated commercial music delivery to streaming services, collaborated with engineering team to implement DDEX and XML conten delivery, automating music ingestion from content providers and distribution to DSPs, increasing catalog onboarding from 1,000 tracks/month to 10,000 tracks/month.
- Integrating third-party music analysis API to filter tracks by tempo, mood, and other metadata, and coordinated with operations to package and sell curated music bundles. 

Education
======

* **Emlyon Business School**  | Paris, France - September 2024 - Expected February 2026 | 
  Master of Science in Digital Marketing and Data Science
...
- Dirigé la mise en place complète d’un système de transfert DDEX + FTP, facilitant l’acquisition et l’intégration de contenus musicaux japonais dans le catalogue numérique de l’entreprise.

### Music Copyright Operation (intern)  
**Kanjian Music(en.kanjian.com)** | Shanghai, China | Septembre 2015 – Mars 2018 (2 ans)  
- Plateforme optimisée de distribution des droits musicaux et livraison automatisée de musique commerciale aux services de streaming, en collaboration avec l’équipe d’ingénierie pour mettre en œuvre la livraison de contenu DDEX et XML, automatisant l’ingestion de musique depuis les fournisseurs de contenu et la distribution vers les DSP, augmentant l’intégration du catalogue de 1 000 titres par mois à 10 000 titres par mois.
- Intégration d'une API d'analyse musicale tierce pour filtrer les morceaux selon le tempo, l'ambiance et d'autres métadonnées, et coordination avec les opérations pour concevoir et vendre des ensembles musicaux sélectionnés.
